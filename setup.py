...
setup(
    ...
    version='1.0',
    packages=['solvation_predictor', 'solvation_predictor.data', 'solvation_predictor.train', 'solvation_predictor.models', 'solvation_predictor.features',
              'solvation_predictor.solubility'],
    package_data={"solvation_predictor":["trained_models/*/*.pt", "solubility/*.json"]},
